...
func (t *AlertmanagerTask) create() error {
...
func (t *AlertmanagerTask) destroy() error {
	r, err := t.factory.AlertmanagerRoute()
	if err != nil {
		return errors.Wrap(err, "initializing Alertmanager Route failed")
	}
...

	{
		...
		if err := t.client.DeleteConfigMap(trustedCA); err != nil {
		...
		err = t.client.DeleteAlertmanager(a)
		if err != nil {
			return errors.Wrap(err, "reconciling Alertmanager object failed")
		}
	}
	...
	err = t.client.DeletePrometheusRule(pr)
	if err != nil {
	...
	err = t.client.DeleteServiceMonitor(smam)
