...
const (
	...
	// MinimalCollectionProfile collects metrics used by recording, alerting, dashboards and Telemetry.
	MinimalCollectionProfile = "minimal"

	// TelemetryCollectionProfile collects metrics used by Telemetry.
