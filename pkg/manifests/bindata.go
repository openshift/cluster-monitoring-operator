...
func assetsPrometheusK8sServiceMonitorKubeSchedulerYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/prometheus-k8s/service-monitor-kube-scheduler.yaml", size: 559, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
