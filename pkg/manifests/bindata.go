...
func assetsPrometheusK8sRulesYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/prometheus-k8s/rules.yaml", size: 56395, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
