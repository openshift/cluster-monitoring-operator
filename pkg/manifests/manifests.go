...
var (
	...
	PrometheusK8sMeteringReportingOperatorServiceMonitor = "assets/prometheus-k8s/service-monitor-metering-reporting-operator.yaml"
	PrometheusK8sMeteringPrestoServiceMonitor            = "assets/prometheus-k8s/service-monitor-metering-presto.yaml"
...
func (f *Factory) PrometheusK8sMeteringReportingOperatorServiceMonitor() (*monv1.ServiceMonitor, error) {
	s, err := f.NewServiceMonitor(MustAssetReader(PrometheusK8sMeteringReportingOperatorServiceMonitor))
	if err != nil {
		return nil, err
	}
...
func (f *Factory) PrometheusK8sMeteringPrestoServiceMonitor() (*monv1.ServiceMonitor, error) {
	s, err := f.NewServiceMonitor(MustAssetReader(PrometheusK8sMeteringPrestoServiceMonitor))
	if err != nil {
		return nil, err
	}
