...
var (
	...
	PrometheusK8sAlertRelabelConfigs         = "prometheus-k8s/alert-rabel-configs-secret.yaml"
...
func (f *Factory) PrometheusK8sAlertRelabelConfigs() (*v1.Secret, error) {
	s, err := f.NewSecret(f.assets.MustNewAssetReader(PrometheusK8sAlertRelabelConfigs))
	if err != nil {
		return nil, err
	}
