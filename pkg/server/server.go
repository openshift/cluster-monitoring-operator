...
func (s *Server) Run(ctx context.Context, collectionProfilesEnabled bool) error {
	...
	openSSLCiphers := configv1.TLSProfiles[configv1.TLSProfileIntermediateType].Ciphers
	servingInfo.ServingInfo.CipherSuites = crypto.OpenSSLToIANACipherSuites(openSSLCiphers)
