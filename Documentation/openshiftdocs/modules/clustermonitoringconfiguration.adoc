...
|alertmanagerMain|*link:alertmanagermainconfig.adoc[AlertmanagerMainConfig]|The `AlertmanagerMainConfig` resource defines settings for the main Alertmanager instance.
