...
data:
  metrics.yaml: |-
    ...
    # owners: (@openshift/team-hypershift-maintainers)
    #
    # cluster_id:hypershift_nodepools_size:sum is the total number of desired nodepool replicas managed by the hypershift operator per HostedCluster
    - '{__name__="cluster_id:hypershift_nodepools_size:sum"}'
    #
    # owners: (@openshift/team-hypershift-maintainers)
    #
    # cluster_id:hypershift_nodepools_available_replicas:sum is the actual number of available nodepool replicas managed by the hypershift operator per HostedCluster
    - '{__name__="cluster_id:hypershift_nodepools_available_replicas:sum"}'
    #
