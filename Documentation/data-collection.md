...
data:
  metrics.yaml: |-
    ...
    - '{__name__="collector:node_scrape_collector_success:avg",collector=~"ethtool|cpufreq|tcpstat|netdev|netclass|buddyinfo|mountstats|ksmd|processes|systemd|dmmultipath|nvmesubsystem"}'
    #
    # owners: (@openshift/openshift-team-monitoring)
    #
