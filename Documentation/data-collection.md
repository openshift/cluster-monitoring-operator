...
data:
  metrics.yaml: |-
    ...
    #
    # (@red-hat-data-services/odh, Open Data Hub team) The cumulative CPU usage for all ODH managed Jupyterhub user pods
    - '{__name__="cluster:usage:consumption:rhods:cpu_core_seconds:rate5m"}'
    #
kind: ConfigMap
metadata:
