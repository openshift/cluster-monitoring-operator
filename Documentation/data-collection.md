...
data:
  metrics.yaml: |-
    ...
    # owners: (@openshift/openshift-team-cincinnati)
    #
    # cluster_version_risk_conditions captures update risk evaluation
    # from the cluster version operator, and can be used to identify
    # whether a particular update risk condition is prevalent, and how
    # successfully that risk is being evaluated.
    #
    # consumers: (@openshift/openshift-team-cluster-manager)
    - '{__name__="cluster_version_risk_conditions", condition="Applies"}'
    #
