...
data:
  metrics.yaml: |-
    ...
    - '{__name__="cluster:ovnkube_clustermanager_cluster_user_defined_networks:max",role=~"Primary|Secondary",topology=~"Layer2|Layer3",transport=~"Default|NoOverlay|EVPN"}'
    #
