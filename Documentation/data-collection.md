...
data:
  metrics.yaml: |-
    ...
    #
    # cluster:ramen_dr_policy_type:sum tracks the number of DRPolicy resources
    # by disaster recovery type.
    # Labels:
    # * dr_type: "metro", "regional", "unknown".
    - '{__name__="cluster:ramen_dr_policy_type:sum"}'
    #
    # owners: (https://github.com/RamenDR/ramen)
    #
    # cluster:ramen_dr_protected_apps:sum tracks the number of DR-protected
    # applications by management method.
    # Labels:
    # * management_method: "discovered", "managed".
    - '{__name__="cluster:ramen_dr_protected_apps:sum"}'
    #
    ...
    - '{__name__="collector:node_scrape_collector_success:avg",collector=~"ethtool|cpufreq|tcpstat|netdev|netclass|buddyinfo|mountstats|ksmd|processes|systemd|softirqs|zoneinfo|dmmultipath|nvmesubsystem"}'
    #
    # owners: (@openshift/openshift-team-monitoring)
    #
