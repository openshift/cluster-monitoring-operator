...
func BuildExternalDocLinks(kubeAPIVersion, prometheusOperatorVersion string) {
	externalLinks = map[string]string{
		...
		"monv1.BasicAuth":                     fmt.Sprintf("https://github.com/prometheus-operator/prometheus-operator/blob/%s/Documentation/api.md#basicauth", prometheusOperatorVersion),
		"monv1.EmbeddedPersistentVolumeClaim": fmt.Sprintf("https://github.com/prometheus-operator/prometheus-operator/blob/%s/Documentation/api.md#embeddedpersistentvolumeclaim", prometheusOperatorVersion),
		"monv1.MetadataConfig":                fmt.Sprintf("https://github.com/prometheus-operator/prometheus-operator/blob/%s/Documentation/api.md#metadataconfig", prometheusOperatorVersion),
		"monv1.QueueConfig":                   fmt.Sprintf("https://github.com/prometheus-operator/prometheus-operator/blob/%s/Documentation/api.md#queueconfig", prometheusOperatorVersion),
