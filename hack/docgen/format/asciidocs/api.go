...
* If the configuration isn't valid YAML data, the Cluster Monitoring Operator stops reconciling the resources and reports ` + "`Degraded=True`" + ` in the status conditions of the Operator.
====
`
