...
TOP_DIR="${1:-.}"
find "${TOP_DIR}" -path "${TOP_DIR}/vendor" -prune -o -path  "${TOP_DIR}/hack/tools/vendor" -prune -o -path "${TOP_DIR}/jsonnet/vendor" -prune -o -type f -name '*.sh' -exec shellcheck --format=gcc {} \+
