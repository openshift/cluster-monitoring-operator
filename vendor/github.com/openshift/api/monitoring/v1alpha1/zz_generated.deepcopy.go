...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlertRelabelConfigCondition) DeepCopyInto(out *AlertRelabelConfigCondition) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlertRelabelConfigCondition.
func (in *AlertRelabelConfigCondition) DeepCopy() *AlertRelabelConfigCondition {
	if in == nil {
		return nil
	}
	out := new(AlertRelabelConfigCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AlertRelabelConfigStatus) DeepCopyInto(out *AlertRelabelConfigStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]AlertRelabelConfigCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
