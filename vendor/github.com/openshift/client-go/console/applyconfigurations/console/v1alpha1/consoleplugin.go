...
// ConsolePluginApplyConfiguration represents an declarative configuration of the ConsolePlugin type for use
// with apply.
...
// ConsolePlugin constructs an declarative configuration of the ConsolePlugin type for use with
// apply.
func ConsolePlugin(name string) *ConsolePluginApplyConfiguration {
	b := &ConsolePluginApplyConfiguration{}
	b.WithName(name)
	b.WithKind("ConsolePlugin")
	b.WithAPIVersion("console.openshift.io/v1alpha1")
	return b
}
...
func extractConsolePlugin(consolePlugin *consolev1alpha1.ConsolePlugin, fieldManager string, subresource string) (*ConsolePluginApplyConfiguration, error) {
	b := &ConsolePluginApplyConfiguration{}
	err := managedfields.ExtractInto(consolePlugin, internal.Parser().Type("com.github.openshift.api.console.v1alpha1.ConsolePlugin"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
	b.WithName(consolePlugin.Name)
...
func (b *ConsolePluginApplyConfiguration) WithSpec(value *ConsolePluginSpecApplyConfiguration) *ConsolePluginApplyConfiguration {
	b.Spec = value
	return b
}
