...
// ConsoleSampleApplyConfiguration represents an declarative configuration of the ConsoleSample type for use
// with apply.
...
// ConsoleSample constructs an declarative configuration of the ConsoleSample type for use with
// apply.
