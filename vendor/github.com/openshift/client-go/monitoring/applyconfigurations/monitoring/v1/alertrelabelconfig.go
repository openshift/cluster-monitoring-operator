...
func (b *AlertRelabelConfigApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *AlertRelabelConfigApplyConfiguration) GetAPIVersion() *string {
...
func (b *AlertRelabelConfigApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
