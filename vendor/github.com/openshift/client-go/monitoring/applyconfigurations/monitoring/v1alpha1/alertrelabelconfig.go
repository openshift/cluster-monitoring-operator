...
// Experimental!
func ExtractAlertRelabelConfig(alertRelabelConfig *monitoringv1alpha1.AlertRelabelConfig, fieldManager string) (*AlertRelabelConfigApplyConfiguration, error) {
...
// Experimental!
func ExtractAlertRelabelConfigStatus(alertRelabelConfig *monitoringv1alpha1.AlertRelabelConfig, fieldManager string) (*AlertRelabelConfigApplyConfiguration, error) {
	return extractAlertRelabelConfig(alertRelabelConfig, fieldManager, "status")
}

func extractAlertRelabelConfig(alertRelabelConfig *monitoringv1alpha1.AlertRelabelConfig, fieldManager string, subresource string) (*AlertRelabelConfigApplyConfiguration, error) {
	b := &AlertRelabelConfigApplyConfiguration{}
