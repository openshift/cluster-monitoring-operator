...
type RelabelConfigApplyConfiguration struct {
	SourceLabels []v1alpha1.LabelName `json:"sourceLabels,omitempty"`
...
func (b *RelabelConfigApplyConfiguration) WithSourceLabels(values ...v1alpha1.LabelName) *RelabelConfigApplyConfiguration {
	for i := range values {
