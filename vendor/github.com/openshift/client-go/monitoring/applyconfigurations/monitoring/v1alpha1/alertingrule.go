...
// Experimental!
func ExtractAlertingRule(alertingRule *monitoringv1alpha1.AlertingRule, fieldManager string) (*AlertingRuleApplyConfiguration, error) {
...
// Experimental!
func ExtractAlertingRuleStatus(alertingRule *monitoringv1alpha1.AlertingRule, fieldManager string) (*AlertingRuleApplyConfiguration, error) {
	return extractAlertingRule(alertingRule, fieldManager, "status")
}

func extractAlertingRule(alertingRule *monitoringv1alpha1.AlertingRule, fieldManager string, subresource string) (*AlertingRuleApplyConfiguration, error) {
	b := &AlertingRuleApplyConfiguration{}
	err := managedfields.ExtractInto(alertingRule, internal.Parser().Type("com.github.openshift.api.monitoring.v1alpha1.AlertingRule"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
